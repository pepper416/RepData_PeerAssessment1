...
```{r, histogram_total_steps, fig.height= 5}
...
```
<b>Conclusion</b>: The total number of steps taken per day has the mean of <b><font color="red">`r round(daily_data_mean,0)`</font></b> and the mediam of <b><font color="red">`r round(daily_data_median,0)`</font></b>.
...
```{r, plot_avg_daily_pattern, fig.height= 5}
...
```
<b>Conclusion:</b> Interval <b><font color="red">`r max_interval`</font></b> has the maximum number of steps on average across all the days, the maximum is `r max_steps` steps.
...
```
<b>Conclusion:</b> total number of rows with NAs is <b><font color="red">`r number_NA`</font></b>.
...
```
<b>Conclusion</b>: After filling in the missing value, the total number of steps taken per day has the mean of <b><font color="red">`r round(daily_data_mean_new,0)`</font></b> and the mediam of <b><font color="red">`r round(daily_data_median_new,0)`</font></b>.
